<div class="card bg-info text-white rounded-0 col-xs-12 col-6 mx-auto p-0 mb-2">
    ...
    <div class="alert alert-info rounded-0 m-0 comentario-box" id="comentario-box-${post.id?string['0']}">
